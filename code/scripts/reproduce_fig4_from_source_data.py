...
SOURCE_DATA_PATH = os.path.join(REPO_ROOT, "data", "source_data", "main", "Fig4_source_data.csv")
TRAFFIC_DATA_PATH = os.path.join(REPO_ROOT, "data", "source_data", "main", "Fig4_traffic_network.csv")
