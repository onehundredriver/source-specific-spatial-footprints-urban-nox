...
# ============================================================
# Reproduce Fig. 4 from public source data
# Input:
#   data/source_data/main/Fig4_source_data.csv
# Output:
#   figures/main/Fig4_reproduced_from_source_data.png
#   figures/main/Fig4_reproduced_from_source_data.pdf
# ============================================================
...
OUTPUT_PNG = os.path.join(OUTPUT_DIR, "Fig4_reproduced_from_source_data.png")
OUTPUT_PDF = os.path.join(OUTPUT_DIR, "Fig4_reproduced_from_source_data.pdf")
...
def main():
    ...
    for col in required_cols:
        if col not in df_points.columns:
            raise ValueError(f"Missing required column in Fig4_source_data.csv: {col}")
    ...
    print("Fig. 4 reproduced from source data.")
