...
# ============================================================
# Reproduce Supplementary Fig. 9 from public source data
# Input:
...
SOURCE_DATA_XLSX = os.path.join(
    ...
    "source_data",
    "supplementary",
    "Supplementary_Fig9_source_data.xlsx"
)
...
OUTPUT_PDF = os.path.join(
    OUTPUT_DIR,
    "Supplementary_Fig9_reproduced_from_source_data.pdf"
)

OUTPUT_PNG = os.path.join(
    OUTPUT_DIR,
    "Supplementary_Fig9_reproduced_from_source_data.png"
)
...
def plot_figure(
    ...
    print("Supplementary Fig. 9 reproduced from source data.")
