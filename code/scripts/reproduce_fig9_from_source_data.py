...
# ============================================================
# Reproduce Fig. 9 from compact public source data
# Input:
#   data/source_data/main/Fig9_source_data.csv
# Output:
#   figures/main/Fig9_reproduced_from_source_data.png
#   figures/main/Fig9_reproduced_from_source_data.pdf
# ============================================================
...
OUTPUT_PNG = os.path.join(OUTPUT_DIR, "Fig9_reproduced_from_source_data.png")
OUTPUT_PDF = os.path.join(OUTPUT_DIR, "Fig9_reproduced_from_source_data.pdf")
...
def main():
    ...
    print("Fig. 9 reproduced from source data.")
