...
SOURCE_DATA_PATH = os.path.join(
    ...
    "source_data",
    "supplementary",
    "Supplementary_Fig8_source_data.csv"
)
...
OUTPUT_PNG = os.path.join(
    OUTPUT_DIR,
    "Supplementary_Fig8_reproduced_from_source_data.png"
)

OUTPUT_PDF = os.path.join(
    OUTPUT_DIR,
    "Supplementary_Fig8_reproduced_from_source_data.pdf"
)
...
def main():
    ...
    print("Supplementary Fig. 8 reproduced from source data.")
