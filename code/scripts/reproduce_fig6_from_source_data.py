...
# Output:
#   figures/main/Fig6_reproduced_from_source_data.png
#   figures/main/Fig6_reproduced_from_source_data.pdf
# ============================================================
...
OUTPUT_PNG = os.path.join(OUTPUT_DIR, "Fig6_reproduced_from_source_data.png")
...
def main():
    ...
    print("Fig. 6 reproduced from source data.")
