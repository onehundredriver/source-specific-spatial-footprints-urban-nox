...
# ============================================================
# Reproduce Fig. 5 from public source data
# Input:
#   data/source_data/main/Fig5_source_data.csv
# Output:
...
OUTPUT_PNG = os.path.join(OUTPUT_DIR, "Fig5_reproduced_from_source_data.png")
OUTPUT_PDF = os.path.join(OUTPUT_DIR, "Fig5_reproduced_from_source_data.pdf")
...
def main():
    ...
    for col in required_cols:
        if col not in df_points.columns:
            raise ValueError(f"Missing required column in Fig5_source_data.csv: {col}")
    ...
    print("Fig. 5 reproduced from source data.")
