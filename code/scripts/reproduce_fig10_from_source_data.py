...
# ============================================================
# Reproduce Fig. 10 from compact public source data
# Input:
#   data/source_data/main/Fig10_source_data.csv
# Output:
#   figures/main/Fig10_reproduced_from_source_data.png
#   figures/main/Fig10_reproduced_from_source_data.pdf
# ============================================================
...
OUTPUT_PNG = os.path.join(OUTPUT_DIR, "Fig10_reproduced_from_source_data.png")
OUTPUT_PDF = os.path.join(OUTPUT_DIR, "Fig10_reproduced_from_source_data.pdf")
...
def main():
    ...
    for col in required_cols:
        if col not in df.columns:
            raise ValueError(f"Missing required column in Fig10_source_data.csv: {col}")
    ...
    print("Fig. 10 reproduced from source data.")
