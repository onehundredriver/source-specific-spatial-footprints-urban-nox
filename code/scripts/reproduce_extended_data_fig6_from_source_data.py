...
# ============================================================
# Reproduce Extended Data Fig. 6 from compact public source data
# Input:
#   data/source_data/extended_data/Extended_Data_Fig6_source_data.csv
# Output:
#   figures/extended_data/Extended_Data_Fig6_reproduced_from_source_data.png
#   figures/extended_data/Extended_Data_Fig6_reproduced_from_source_data.pdf
# ============================================================
...
SOURCE_DATA_PATH = os.path.join(
    ...
    "source_data",
    "extended_data",
    "Extended_Data_Fig6_source_data.csv"
)
...
OUTPUT_PNG = os.path.join(OUTPUT_DIR, "Extended_Data_Fig6_reproduced_from_source_data.png")
OUTPUT_PDF = os.path.join(OUTPUT_DIR, "Extended_Data_Fig6_reproduced_from_source_data.pdf")
...
def main():
    ...
    for col in required_cols:
        if col not in df.columns:
            raise ValueError(f"Missing required column in Extended_Data_Fig6_source_data.csv: {col}")
    ...
    print("Extended Data Fig. 6 reproduced from source data.")
